...
RMAPI float Vector2Distance(sf::Vector2f v1, sf::Vector2f v2)
{
...
RMAPI float Vector2Angle(sf::Vector2f v1, sf::Vector2f v2)
{
...
RMAPI sf::Vector2f Vector2Normalize(sf::Vector2f v)
{
    sf::Vector2f result;
...
RMAPI sf::Vector2f Vector2Clamp(sf::Vector2f v, sf::Vector2f min, sf::Vector2f max)
{
    sf::Vector2f result;
